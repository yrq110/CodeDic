...
//                [self.view insertSubview:self.leftViewController.view atIndex:1];
...
- (void)resetNavButtons {
    ...
    if ([_root isKindOfClass:[UINavigationController class]]) {
        ...
        UIImage *navigationbarBgImage = [UIImage imageNamed:@"title.png"];
        [navController.navigationBar setBackgroundImage:navigationbarBgImage forBarMetrics:UIBarMetricsDefault];
    ...
    if (_menuFlags.canShowRight) {
//        UIBarButtonItem *button = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"title-btn-list@2x.png"] style:UIBarButtonItemStylePlain  target:self action:@selector(showRight:)];
...
//        [btn setFrame:CGRectMake(img.size.width/2+10, 9, img.size.width/2, img.size.height/2)];
//        [topController.navigationController.navigationBar addSubview:btn];
...
//    UIView *blackView=[[UIView alloc]initWithFrame:_root.view.frame];
//    blackView.backgroundColor=[UIColor blackColor];
//    [_root.view addSubview:blackView];
//    blackView.alpha=0;
